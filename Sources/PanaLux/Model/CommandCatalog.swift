    ...
    private init() {
        ...
        cats.append(CommandCategory(
            ...
            items: [
                ...
                CatalogCommand(id: RewindCommands.landmarks, title: "Previous / Next Landmark",
                               subtitle: "Turn to visit saved marks and structural edits", isParameter: true, icon: "bookmark"),
                CatalogCommand(id: RewindCommands.tangents, title: "Previous / Next Tangent",
                               subtitle: "Turn to compare saved versions", isParameter: true, icon: "arrow.triangle.branch"),
