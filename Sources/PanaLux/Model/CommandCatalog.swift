    ...
    private init() {
        ...
        cats.append(CommandCategory(
            ...
            items: [
                ...
                CatalogCommand(id: RewindCommands.takePrevious, title: "Previous Take",
                               subtitle: "Hops to the take before this one, at the same moment. A/B in one press",
                               isParameter: false, icon: "chevron.up"),
                CatalogCommand(id: RewindCommands.takeNext, title: "Next Take",
                               subtitle: "Hops to the next take, at the same moment", isParameter: false, icon: "chevron.down"),
