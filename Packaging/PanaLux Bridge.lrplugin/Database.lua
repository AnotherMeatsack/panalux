...
local HDR = LOC('$$$/AgCameraRawUI/HDR=HDR')
...
local resetColorAdjustments = LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',colorAdjustments)
...
local lensBlur = LOC('$$$/AgDevelop/Panel/LensBlur=Lens Blur')
...
local localadjresets = LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj)
...
--local tempgroup = 'TEMPORARY GROUP FOR TESTING' --delete before release

--construct complex strings used more than once
local SDRBlendString = LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SettingsString/ConstructionWithColon=^1: ^2',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SDRRenditionSettings=SDR Rendition Settings'),LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SDRBlend=Highlight Saturation'))
local SDRBrightnessString = LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SettingsString/ConstructionWithColon=^1: ^2',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SDRRenditionSettings=SDR Rendition Settings'),LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SDRBrightness=Brightness'))
local SDRClarityString = LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SettingsString/ConstructionWithColon=^1: ^2',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SDRRenditionSettings=SDR Rendition Settings'),LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SDRClarity=Clarity'))
local SDRContrastString = LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SettingsString/ConstructionWithColon=^1: ^2',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SDRRenditionSettings=SDR Rendition Settings'),LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SDRContrast=Contrast'))
local SDRHighlightsString = LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SettingsString/ConstructionWithColon=^1: ^2',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SDRRenditionSettings=SDR Rendition Settings'),LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SDRHighlights=Highlights'))
local SDRShadowsString = LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SettingsString/ConstructionWithColon=^1: ^2',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SDRRenditionSettings=SDR Rendition Settings'),LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SDRShadows=Shadows'))
local SDRWhitesString = LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SettingsString/ConstructionWithColon=^1: ^2',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SDRRenditionSettings=SDR Rendition Settings'),LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SDRWhites=Whites'))
...
local DataBase = {
  ...
  {Command='FilterNone',Type='button',Translation=LOC('$$$/AgLibrary/FilterPresets/NoFilter=No filter'),Group=filter,Explanation='Library filters off.'},
  --view
  {Command='SwToMlibrary',Type='button',Translation=LOC('$$$/AgDevelop/Localized/Mask/Show=Show ^1',LOC('$$$/AgLibraryModule/ModuleTitle=Library')),Group=view,Explanation='Switch to Library module.'},
...
--rating
  ...
  --quick develop
  {Command='QuickDevTempLarge',Type='button',Translation=quickdev..' '..LOC('$$$/AgLibrary/MiniDevelop/WarmerTemperture=Make warmer')..' 20',Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Temperature by 20 for all selected photos. Works in Library and Develop modules.'},
  {Command='QuickDevTempLargeDec',Type='button',Translation=quickdev..' '..LOC('$$$/AgLibrary/MiniDevelop/CoolerTemperture=Make cooler')..' -20',Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Temperature by -20 for all selected photos. Works in Library and Develop modules.'},
  {Command='QuickDevTempSmall',Type='button',Translation=quickdev..' '..LOC('$$$/AgLibrary/MiniDevelop/WarmerTemperture=Make warmer')..' 5',Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Temperature by 5 for all selected photos. Works in Library and Develop modules.'},
  {Command='QuickDevTempSmalDec',Type='button',Translation=quickdev..' '..LOC('$$$/AgLibrary/MiniDevelop/CoolerTemperture=Make cooler')..' -5',Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Temperature by -5 for all selected photos. Works in Library and Develop modules.'},
  ...
  {Command='QuickDevTintLarge',Type='button',Translation=quickdev..' '..LOC('$$$/AgLibrary/MiniDevelop/IncreaseTint=Tint more magenta') .. ' 20',Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Tint by 20 for all selected photos. Works in Library and Develop modules.'},
  {Command='QuickDevTintLargeDec',Type='button',Translation=quickdev..' '..LOC('$$$/AgLibrary/MiniDevelop/DecreaseTint=Tint more green') .. ' -20',Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Tint by -20 for all selected photos. Works in Library and Develop modules.'},
  {Command='QuickDevTintSmall',Type='button',Translation=quickdev..' '..LOC('$$$/AgLibrary/MiniDevelop/IncreaseTint=Tint more magenta') .. ' 5',Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Tint by 5 for all selected photos. Works in Library and Develop modules.'},
  {Command='QuickDevTintSmallDec',Type='button',Translation=quickdev..' '..LOC('$$$/AgLibrary/MiniDevelop/DecreaseTint=Tint more green') .. ' -5',Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Tint by -5 for all selected photos. Works in Library and Develop modules.'},
  ...
  {Command='QuickDevExpSmHalf',Type='button',Translation=quickdev..' '..LOC('$$$/AgLibrary/MiniDevelop/IncreaseExposureSmHalf=Increase exposure 1/6 stop'),Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Exposure by +0.16 for all selected photos. Works in Library and Develop modules.'},
  {Command='QuickDevExpSmHalfDec',Type='button',Translation=quickdev..' '..LOC('$$$/AgLibrary/MiniDevelop/DecreaseExposureSmHalf=Decrease exposure 1/6 stop'),Group=quickdev,Explanation='Using the Library\226\128\153s quick develop mode, adjusts Exposure by -0.16 for all selected photos. Works in Library and Develop modules.'},
  ...
  {Command='ResetLast',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/LibraryUpgradeCatalogUtils/CatalogInfo/LastModified/Label=Last Modified'):gsub(' ?:','')),Group=develop,Explanation='Resets the last parameter that was adjusted by an encoder or fader to default.'},
  ...
  {Command='Fine2',Type='button',Translation=LOC('$$$/AgCameraRaw/LocalizedCorrections/LocalHue/FineAdjustment=Fine correction')..' 2×',Group=develop,Explanation='Controls make 2× finer adjustment. Pressing button again returns to normal edit mode. Only works in Develop module with an image selected.'},
  {Command='Fine4',Type='button',Translation=LOC('$$$/AgCameraRaw/LocalizedCorrections/LocalHue/FineAdjustment=Fine correction')..' 4×',Group=develop,Explanation='Controls make 4× finer adjustment. Pressing button again returns to normal edit mode. Only works in Develop module with an image selected.'},
  {Command='Fine8',Type='button',Translation=LOC('$$$/AgCameraRaw/LocalizedCorrections/LocalHue/FineAdjustment=Fine correction')..' 8×',Group=develop,Explanation='Controls make 8× finer adjustment. Pressing button again returns to normal edit mode. Only works in Develop module with an image selected.'},
  {Command='Fine16',Type='button',Translation=LOC('$$$/AgCameraRaw/LocalizedCorrections/LocalHue/FineAdjustment=Fine correction')..' 16×',Group=develop,Explanation='Controls make 16× finer adjustment. Pressing button again returns to normal edit mode. Only works in Develop module with an image selected.'},
  {Command='FineOff',Type='button',Translation=LOC('$$$/AgCameraRaw/LocalizedCorrections/LocalHue/FineAdjustment=Fine correction')..' '..LOC('$$$/AgDevelop/Enhance/Off=Off'),Group=develop,Explanation='Pressing button cancels fine edit mode and returns to normal edit mode. Only works in Develop module with an image selected.'},
  {Command='FineIncrease',Type='button',Translation=LOC('$$$/AgCameraRawController/TargetAdjustment/Increase=^1 increase: ^2',LOC('$$$/AgCameraRaw/LocalizedCorrections/LocalHue/FineAdjustment=Fine correction'),'2×'),Group=develop,Explanation='Pressing button doubles fineness of adjustment, or, if fine adjustment is off, provides 2× finer adjustment. Only works in Develop module with an image selected.'},
  {Command='FineDecrease',Type='button',Translation=LOC('$$$/AgCameraRawController/TargetAdjustment/Decrease=^1 decrease: ^2',LOC('$$$/AgCameraRaw/LocalizedCorrections/LocalHue/FineAdjustment=Fine correction'),'2×'),Group=develop,Explanation='Pressing button halves fineness of adjustment, or, if fine adjustment is 2×, turns off fine adjustment. Only works in Develop module with an image selected.'},
  ...
  {Command='ResetTemperature',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/Temperature=Temperature')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetTint',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawUI/Tint=Tint')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetExposure',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawUI/Exposure=Exposure')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetContrast',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawUI/Contrast=Contrast')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetHighlights',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawUI/Highlights=Highlights')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetShadows',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawUI/Shadows=Shadows')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetWhites',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawUI/Whites=Whites')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetBlacks',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawUI/Blacks=Blacks')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetTexture',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawUI/Texture=Texture')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetClarity',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawUI/Clarity=Clarity')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetDehaze',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawUI/DehazeAmount=Dehaze Amount')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetVibrance',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawUI/Vibrance=Vibrance')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},
  {Command='ResetSaturation',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawUI/Saturation=Saturation')),Group=basicTone,Explanation='Reset to default.',Panel='adjustPanel'},

  --
  --develop: HDR controls
  --
  {Command='HDREditMode',Type='button',Experimental=true,Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HDREditMode=Enable HDR Edit Mode'),Group=HDR,Explanation='Press to enable HDR edit mode. Press again to disable.',Panel='adjustPanel'},
  {Command='SDRBlend',Type='parameter',Translation=SDRBlendString,Group=HDR,Explanation='Adjust how your HDR photo is tone mapped to SDR: highlight saturation. SDR preview *must* be enabled for this to work properly.',Panel='adjustPanel'},
  {Command='ResetSDRBlend',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',SDRBlendString),Group=HDR,Explanation='Reset to default. SDR preview *must* be enabled for this to work properly.',Panel='adjustPanel'},
  {Command='SDRBrightness',Type='parameter',Translation=SDRBrightnessString,Group=HDR,Explanation='Adjust how your HDR photo is tone mapped to SDR: brightness. SDR preview *must* be enabled for this to work properly.',Panel='adjustPanel'},
  {Command='ResetSDRBrightness',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',SDRBrightnessString),Group=HDR,Explanation='Reset to default. SDR preview *must* be enabled for this to work properly.',Panel='adjustPanel'},
  {Command='SDRClarity',Type='parameter',Translation=SDRClarityString,Group=HDR,Explanation='Adjust how your HDR photo is tone mapped to SDR: clarity. SDR preview *must* be enabled for this to work properly.',Panel='adjustPanel'},
  {Command='ResetSDRClarity',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',SDRClarityString),Group=HDR,Explanation='Reset to default. SDR preview *must* be enabled for this to work properly.',Panel='adjustPanel'},
  {Command='SDRContrast',Type='parameter',Translation=SDRContrastString,Group=HDR,Explanation='Adjust how your HDR photo is tone mapped to SDR: contrast. SDR preview *must* be enabled for this to work properly.',Panel='adjustPanel'},
  {Command='ResetSDRContrast',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',SDRContrastString),Group=HDR,Explanation='Reset to default. SDR preview *must* be enabled for this to work properly.',Panel='adjustPanel'},
  {Command='SDRHighlights',Type='parameter',Translation=SDRHighlightsString,Group=HDR,Explanation='Adjust how your HDR photo is tone mapped to SDR: highlights. SDR preview *must* be enabled for this to work properly.',Panel='adjustPanel'},
  {Command='ResetSDRHighlights',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',SDRHighlightsString),Group=HDR,Explanation='Reset to default. SDR preview *must* be enabled for this to work properly.',Panel='adjustPanel'},
  {Command='SDRShadows',Type='parameter',Translation=SDRShadowsString,Group=HDR,Explanation='Adjust how your HDR photo is tone mapped to SDR: shadows. SDR preview *must* be enabled for this to work properly.',Panel='adjustPanel'},
  {Command='ResetSDRShadows',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',SDRShadowsString),Group=HDR,Explanation='Reset to default. SDR preview *must* be enabled for this to work properly.',Panel='adjustPanel'},
  {Command='SDRWhites',Type='parameter',Translation=SDRWhitesString,Group=HDR,Explanation='Adjust how your HDR photo is tone mapped to SDR: whites. SDR preview *must* be enabled for this to work properly.',Panel='adjustPanel'},
  {Command='ResetSDRWhites',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',SDRWhitesString),Group=HDR,Explanation='Reset to default. SDR preview *must* be enabled for this to work properly.',Panel='adjustPanel'},
  ...
  {Command='ResetParametricDarks',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ToneDarks=Dark Tones')),Group=toneCurve,Explanation='Reset to default.',Panel='tonePanel'},
  {Command='ResetParametricLights',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ToneLights=Light Tones')),Group=toneCurve,Explanation='Reset to default.',Panel='tonePanel'},
  {Command='ResetParametricShadows',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ToneShadows=Shadow Tones')),Group=toneCurve,Explanation='Reset to default.',Panel='tonePanel'},
  {Command='ResetParametricHighlights',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ToneHighlights=Highlight Tones')),Group=toneCurve,Explanation='Reset to default.',Panel='tonePanel'},
  {Command='ResetParametricShadowSplit',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ToneShadowSplit=Shadow Split')),Group=toneCurve,Explanation='Reset to default.',Panel='tonePanel'},
  {Command='ResetParametricMidtoneSplit',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ToneMidtoneSplit=Midtone Split')),Group=toneCurve,Explanation='Reset to default.',Panel='tonePanel'},
  {Command='ResetParametricHighlightSplit',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ToneHighlightSplit=Highlight Split')),Group=toneCurve,Explanation='Reset to default.',Panel='tonePanel'},
  {Command='ResetCurveRefineSaturation',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgDevelop/Settings/CurveRefineSaturation=Refine Saturation')),Group=toneCurve,Explanation='Reset to default.',Panel='tonePanel'},
  ...
  {Command='PointCurveBlacksUpDown',Type='repeat',Translation=LOC('$$$/AgDevelop/Localized/Panel/Curve=Gradation Curve')..' '..LOC('$$$/AgCameraRawUI/Blacks=Blacks'),Group=toneCurve,Explanation='Turning knob moves the tone curve points for blacks and shadows up and down.'..repeatexp,Repeats={'PointCurveBlacksUp','PointCurveBlacksDown'}},
  {Command='PointCurveHighlightsUpDown',Type='repeat',Translation=LOC('$$$/AgDevelop/Localized/Panel/Curve=Gradation Curve')..' '..LOC('$$$/AgCameraRawUI/Highlights=Highlights'),Group=toneCurve,Explanation='Turning knob moves the tone curve points for highlights and whites up and down.'..repeatexp,Repeats={'PointCurveHighlightsUp','PointCurveHighlightsDown'}},
  --
  --develop: mixer panel
  --
  ...
  {Command='EnableColorAdjustments',Type='button',Translation=LOC('$$$/AgDevelop/Settings/ToggleColorAdjustments=Color adjustments enable/disable'),Group=colorAdjustments,Explanation='Enable or disable color adjustments.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='SaturationAdjustmentRed',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentRed=Saturation Adjustment Red'),Group=colorAdjustments,Explanation='Changes the color vividness or purity of the color.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='SaturationAdjustmentOrange',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentOrange=Saturation Adjustment Orange'),Group=colorAdjustments,Explanation='Changes the color vividness or purity of the color.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='SaturationAdjustmentYellow',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentYellow=Saturation Adjustment Yellow'),Group=colorAdjustments,Explanation='Changes the color vividness or purity of the color.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='SaturationAdjustmentGreen',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentGreen=Saturation Adjustment Green'),Group=colorAdjustments,Explanation='Changes the color vividness or purity of the color.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='SaturationAdjustmentAqua',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentAqua=Saturation Adjustment Aqua'),Group=colorAdjustments,Explanation='Changes the color vividness or purity of the color.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='SaturationAdjustmentBlue',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentBlue=Saturation Adjustment Blue'),Group=colorAdjustments,Explanation='Changes the color vividness or purity of the color.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='SaturationAdjustmentPurple',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentPurple=Saturation Adjustment Purple'),Group=colorAdjustments,Explanation='Changes the color vividness or purity of the color.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='SaturationAdjustmentMagenta',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentMagenta=Saturation Adjustment Magenta'),Group=colorAdjustments,Explanation='Changes the color vividness or purity of the color.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='AllSaturationAdjustment',Type='variable',Translation=LOC('$$$/AgCameraRawNamedSettings/SaveNamedDialog/Saturation=Saturation')..' \226\128\148 '..LOC('$$$/AgDateManagement/ChangeAll=Change all'),Group=colorAdjustments,Explanation='Changes all color vividness or purity of all colors.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='HueAdjustmentRed',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentRed=Hue Adjustment Red'),Group=colorAdjustments,Explanation='Changes the color.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='HueAdjustmentOrange',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentOrange=Hue Adjustment Orange'),Group=colorAdjustments,Explanation='Changes the color.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='HueAdjustmentYellow',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentYellow=Hue Adjustment Yellow'),Group=colorAdjustments,Explanation='Changes the color.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='HueAdjustmentGreen',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentGreen=Hue Adjustment Green'),Group=colorAdjustments,Explanation='Changes the color.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='HueAdjustmentAqua',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentAqua=Hue Adjustment Aqua'),Group=colorAdjustments,Explanation='Changes the color.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='HueAdjustmentBlue',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentBlue=Hue Adjustment Blue'),Group=colorAdjustments,Explanation='Changes the color.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='HueAdjustmentPurple',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentPurple=Hue Adjustment Purple'),Group=colorAdjustments,Explanation='Changes the color.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='HueAdjustmentMagenta',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentMagenta=Hue Adjustment Magenta'),Group=colorAdjustments,Explanation='Changes the color.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='LuminanceAdjustmentRed',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentRed=Luminance Adjustment Red'),Group=colorAdjustments,Explanation='Changes the brightness of the color range.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='LuminanceAdjustmentOrange',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentOrange=Luminance Adjustment Orange'),Group=colorAdjustments,Explanation='Changes the brightness of the color range.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='LuminanceAdjustmentYellow',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentYellow=Luminance Adjustment Yellow'),Group=colorAdjustments,Explanation='Changes the brightness of the color range.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='LuminanceAdjustmentGreen',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentGreen=Luminance Adjustment Green'),Group=colorAdjustments,Explanation='Changes the brightness of the color range.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='LuminanceAdjustmentAqua',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentAqua=Luminance Adjustment Aqua'),Group=colorAdjustments,Explanation='Changes the brightness of the color range.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='LuminanceAdjustmentBlue',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentBlue=Luminance Adjustment Blue'),Group=colorAdjustments,Explanation='Changes the brightness of the color range.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='LuminanceAdjustmentPurple',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentPurple=Luminance Adjustment Purple'),Group=colorAdjustments,Explanation='Changes the brightness of the color range.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='LuminanceAdjustmentMagenta',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentMagenta=Luminance Adjustment Magenta'),Group=colorAdjustments,Explanation='Changes the brightness of the color range.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ConvertToGrayscale',Type='button',Experimental=true,Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ConvertToGrayscale=Convert to Grayscale'),Group=colorAdjustments,Explanation='Enable/disable gray scale conversion.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='EnableGrayscaleMix',Type='button',Translation=LOC('$$$/AgDevelop/Settings/ToggleBlackAndWhiteMix=Grayscale mix enable/disable'),Group=colorAdjustments,Explanation='Enable or disable black and white mix.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='GrayMixerRed',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerRed=Gray Mixer Red'),Group=colorAdjustments,Explanation='Red contribution to luminance.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='GrayMixerOrange',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerOrange=Gray Mixer Orange'),Group=colorAdjustments,Explanation='Orange contribution to luminance.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='GrayMixerYellow',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerYellow=Gray Mixer Yellow'),Group=colorAdjustments,Explanation='Yellow contribution to luminance.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='GrayMixerGreen',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerGreen=Gray Mixer Green'),Group=colorAdjustments,Explanation='Green contribution to luminance.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='GrayMixerAqua',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerAqua=Gray Mixer Aqua'),Group=colorAdjustments,Explanation='Aqua contribution to luminance.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='GrayMixerBlue',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerBlue=Gray Mixer Blue'),Group=colorAdjustments,Explanation='Blue contribution to luminance.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='GrayMixerPurple',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerPurple=Gray Mixer Purple'),Group=colorAdjustments,Explanation='Purple contribution to luminance.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='GrayMixerMagenta',Type='parameter',Translation=LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerMagenta=Gray Mixer Magenta'),Group=colorAdjustments,Explanation='Magenta contribution to luminance.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetSaturationAdjustmentRed',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentRed=Saturation Adjustment Red')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetSaturationAdjustmentOrange',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentOrange=Saturation Adjustment Orange')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetSaturationAdjustmentYellow',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentYellow=Saturation Adjustment Yellow')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetSaturationAdjustmentGreen',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentGreen=Saturation Adjustment Green')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetSaturationAdjustmentAqua',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentAqua=Saturation Adjustment Aqua')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetSaturationAdjustmentBlue',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentBlue=Saturation Adjustment Blue')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetSaturationAdjustmentPurple',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentPurple=Saturation Adjustment Purple')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetSaturationAdjustmentMagenta',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SaturationAdjustmentMagenta=Saturation Adjustment Magenta')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetAllSaturationAdjustment',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgDevelop/Settings/SaturationAdjustment=Saturation Adjustments')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetHueAdjustmentRed',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentRed=Hue Adjustment Red')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetHueAdjustmentOrange',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentOrange=Hue Adjustment Orange')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetHueAdjustmentYellow',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentYellow=Hue Adjustment Yellow')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetHueAdjustmentGreen',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentGreen=Hue Adjustment Green')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetHueAdjustmentAqua',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentAqua=Hue Adjustment Aqua')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetHueAdjustmentBlue',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentBlue=Hue Adjustment Blue')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetHueAdjustmentPurple',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentPurple=Hue Adjustment Purple')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetHueAdjustmentMagenta',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/HueAdjustmentMagenta=Hue Adjustment Magenta')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetAllHueAdjustment',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgDevelop/Settings/HueAdjustment=Hue Adjustments')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetLuminanceAdjustmentRed',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentRed=Luminance Adjustment Red')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetLuminanceAdjustmentOrange',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentOrange=Luminance Adjustment Orange')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetLuminanceAdjustmentYellow',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentYellow=Luminance Adjustment Yellow')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetLuminanceAdjustmentGreen',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentGreen=Luminance Adjustment Green')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetLuminanceAdjustmentAqua',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentAqua=Luminance Adjustment Aqua')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetLuminanceAdjustmentBlue',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentBlue=Luminance Adjustment Blue')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetLuminanceAdjustmentPurple',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentPurple=Luminance Adjustment Purple')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetLuminanceAdjustmentMagenta',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceAdjustmentMagenta=Luminance Adjustment Magenta')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetAllLuminanceAdjustment',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgDevelop/Settings/LuminanceAdjustment=Luminance Adjustments')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetGrayMixerRed',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerRed=Gray Mixer Red')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetGrayMixerOrange',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerOrange=Gray Mixer Orange')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetGrayMixerYellow',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerYellow=Gray Mixer Yellow')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetGrayMixerGreen',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerGreen=Gray Mixer Green')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetGrayMixerAqua',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerAqua=Gray Mixer Aqua')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetGrayMixerBlue',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerBlue=Gray Mixer Blue')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetGrayMixerPurple',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerPurple=Gray Mixer Purple')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetGrayMixerMagenta',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrayMixerMagenta=Gray Mixer Magenta')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  {Command='ResetAllGrayMixer',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgDevelop/Setting/BlackAndWhiteMix=Gray Mixer')),Group=resetColorAdjustments,Explanation='Reset to default.',Panel='mixerPanel',SubPanel='hslColorPanel'},
  --
  ...
  {Command='ResetColorGradeBlending',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeBlending=Color Blending')),Group=colorGrading,Explanation='Reset color grading blending to default.',Panel='colorGradingPanel'},
  {Command='ResetSplitToningBalance',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeBalance=Color Grading Balance')),Group=colorGrading,Explanation='Reset color grading balance to default.',Panel='colorGradingPanel'},
  {Command='ResetColorGradeGlobalHue',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeGlobalHue=Global Hue')),Group=colorGrading,Explanation='Reset color grading global hue to default.',Panel='colorGradingPanel'},
  {Command='ResetColorGradeGlobalLum',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeGlobalLum=Global Luminance')),Group=colorGrading,Explanation='Reset color grading global luminance to default.',Panel='colorGradingPanel'},
  {Command='ResetColorGradeGlobalSat',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeGlobalSat=Global Saturation')),Group=colorGrading,Explanation='Reset color grading global saturation to default.',Panel='colorGradingPanel'},
  {Command='ResetSplitToningHighlightHue',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningHighlightHue=Highlight Hue')),Group=colorGrading,Explanation='Reset color grading highlight hue to default.',Panel='colorGradingPanel'},
  {Command='ResetColorGradeHighlightLum',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeHighlightLum=Highlight Luminance')),Group=colorGrading,Explanation='Reset color grading highlight luminance to default.',Panel='colorGradingPanel'},
  {Command='ResetSplitToningHighlightSaturation',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningHighlightSaturation=Highlight Saturation')),Group=colorGrading,Explanation='Reset color grading highlight saturation to default.',Panel='colorGradingPanel'},
  {Command='ResetColorGradeMidtoneHue',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeMidtoneHue=Midtone Hue')),Group=colorGrading,Explanation='Reset color grading midtone hue to default.',Panel='colorGradingPanel'},
  {Command='ResetColorGradeMidtoneLum',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeMidtoneLum=Midtone Luminance')),Group=colorGrading,Explanation='Reset color grading midtone luminance to default.',Panel='colorGradingPanel'},
  {Command='ResetColorGradeMidtoneSat',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeMidtoneSat=Midtone Saturation')),Group=colorGrading,Explanation='Reset color grading midtone saturation to default.',Panel='colorGradingPanel'},
  {Command='ResetSplitToningShadowHue',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningShadowHue=Shadow Hue')),Group=colorGrading,Explanation='Reset color grading shadow hue to default.',Panel='colorGradingPanel'},
  {Command='ResetColorGradeShadowLum',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorGradeShadowLum=Shadow Luminance')),Group=colorGrading,Explanation='Reset color grading shadow luminance to default.',Panel='colorGradingPanel'},
  {Command='ResetSplitToningShadowSaturation',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SplitToningShadowSaturation=Shadow Saturation')),Group=colorGrading,Explanation='Reset color grading shadow saturation to default.',Panel='colorGradingPanel'},
  --
  ...
  {Command='ResetSharpness',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgDevelop/Localized/Sharpness=Sharpness')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetSharpenRadius',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SharpenRadius=Sharpen Radius')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetSharpenDetail',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SharpenDetail=Sharpen Detail')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetSharpenEdgeMasking',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/SharpenEdgeMasking=Sharpen Edge Masking')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetLuminanceSmoothing',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceSmoothing=Luminance Smoothing')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetLuminanceNoiseReductionDetail',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceNoiseReductionDetail=Luminance Detail')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetLuminanceNoiseReductionContrast',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LuminanceNoiseReductionContrast=Luminance Contrast')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetColorNoiseReduction',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorNoiseReduction=Color Noise Reduction')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetColorNoiseReductionDetail',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorNoiseReductionDetail=Color Noise Reduction Detail')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  {Command='ResetColorNoiseReductionSmoothness',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ColorNoiseReductionSmoothness=Color Noise Reduction Smoothness')),Group=detail,Explanation='Reset to default.',Panel='detailPanel'},
  --
  ...
  {Command='ResetLensProfileDistortionScale',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LensProfileDistortionScale=Lens Profile Distortion Scale')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetLensProfileChromaticAberrationScale',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/SaveNamedDialog/ChromaticAberration=chromatic Aberration'))..' — '..LOC('$$$/AgCameraRawUI/ControlTitle/LensProfileDistortionScale=Scale'),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetLensProfileVignettingScale',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LensProfileVignettingScale=Lens Profile Vignetting Scale')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  ...
  {Command='ResetDefringePurpleAmount',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PurpleDefringeAmount=Defringe Purple Amount')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetDefringePurpleHueLo',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',dph..' - '..LOC('$$$/Slideshow/Panels/PanAndZoom/Low=Low')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetDefringePurpleHueHi',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',dph..' - '..LOC('$$$/Slideshow/Panels/PanAndZoom/High=High')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetDefringeGreenAmount',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GreenDefringeAmount=Defringe Green Amount')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetDefringeGreenHueLo',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',dgh..' - '..LOC('$$$/Slideshow/Panels/PanAndZoom/Low=Low')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetDefringeGreenHueHi',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',dgh..' - '..LOC('$$$/Slideshow/Panels/PanAndZoom/High=High')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  ...
  {Command='ResetLensManualDistortionAmount',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/LensManualDistortionAmount=Lens Manual Distortion Amount')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetVignetteAmount',Type='button',Experimental=true,Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/VignetteAmount=Vignette Amount')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  {Command='ResetVignetteMidpoint',Type='button',Experimental=true,Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/VignetteMidpoint=Vignette Midpoint')),Group=lensCorrections,Explanation='Reset to default.',Panel='lensCorrectionsPanel'},
  --
  ...
  {Command='ResetPerspectiveVertical',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PerspectiveVertical=Perspective Vertical')),Group=transform,Explanation='Reset to default.',Panel='transformPanel'},
  {Command='ResetPerspectiveHorizontal',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PerspectiveHorizontal=Perspective Horizontal')),Group=transform,Explanation='Reset to default.',Panel='transformPanel'},
  {Command='ResetPerspectiveRotate',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PerspectiveRotate=Perspective Rotate')),Group=transform,Explanation='Reset to default.',Panel='transformPanel'},
  {Command='ResetPerspectiveScale',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PerspectiveScale=Perspective Scale')),Group=transform,Explanation='Reset to default.',Panel='transformPanel'},
  {Command='ResetPerspectiveAspect',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PerspectiveAspect=Perspective Aspect')),Group=transform,Explanation='Reset to default.',Panel='transformPanel'},
  {Command='ResetPerspectiveX',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PerspectiveX=Perspective X')),Group=transform,Explanation='Reset to default.',Panel='transformPanel'},
  {Command='ResetPerspectiveY',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PerspectiveY=Perspective Y')),Group=transform,Explanation='Reset to default.',Panel='transformPanel'},
  --
  ...
  {Command='BokehRing',Type='button',Translation=LOC('$$$/AgDevelop/LensBlur/Bokeh/Ring=Ring'),Group=lensBlur,Explanation='Ring: Commonly seen in reflex or mirror lenses, also known as "Doughnut"',Panel='lensBlurPanel'},
  {Command='BokehSoapBubble',Type='button',Translation=LOC('$$$/AgDevelop/LensBlur/Bokeh/Bubble=Bubble'),Group=lensBlur,Explanation='Bubble: Standard circular shape with over-corrected spherical aberration',Panel='lensBlurPanel'},
  {Command='BlurDepthShow', Type='button',Translation=LOC('$$$/AgDevelop/LensBlur/Overlay=Visualize Depth'),Group=lensBlur,Explanation='Press to show/hide blur depth visualization.',Panel='lensBlurPanel'},
  ...
  {Command='ResetPostCropVignetteAmount',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PostCropVignetteAmount=Post Crop Vignette Amount')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
  {Command='ResetPostCropVignetteMidpoint',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PostCropVignetteMidpoint=Post Crop Vignette Midpoint')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
  {Command='ResetPostCropVignetteFeather',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PostCropVignetteFeather=Post Crop Vignette Feather')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
  {Command='ResetPostCropVignetteRoundness',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PostCropVignetteRoundness=Post Crop Vignette Roundness')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
  {Command='ResetPostCropVignetteStyle',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PostCropVignetteStyle=Post Crop Vignette Style')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
  {Command='ResetPostCropVignetteHighlightContrast',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/PostCropVignetteHighlightContrast=Post Crop Vignette Highlight Contrast')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
  {Command='ResetGrainAmount',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrainAmount=Grain Amount')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
  {Command='ResetGrainSize',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrainSize=Grain Size')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
  {Command='ResetGrainFrequency',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GrainRoughness=Grain Roughness')),Group=effects,Explanation='Reset to default.',Panel='effectsPanel'},
  --
  ...
  {Command='ResetShadowTint',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/ShadowTintCalibration=Shadow Tint Calibration')),Group=calibration,Explanation='Reset to default.',Panel='calibratePanel'},
  {Command='ResetRedHue',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/RedHueCalibration=Red Hue Calibration')),Group=calibration,Explanation='Reset to default.',Panel='calibratePanel'},
  {Command='ResetRedSaturation',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/RedSaturationCalibration=Red Saturation Calibration')),Group=calibration,Explanation='Reset to default.',Panel='calibratePanel'},
  {Command='ResetGreenHue',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GreenHueCalibration=Green Hue Calibration')),Group=calibration,Explanation='Reset to default.',Panel='calibratePanel'},
  {Command='ResetGreenSaturation',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/GreenSaturationCalibration=Green Saturation Calibration')),Group=calibration,Explanation='Reset to default.',Panel='calibratePanel'},
  {Command='ResetBlueHue',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/BlueHueCalibration=Blue Hue Calibration')),Group=calibration,Explanation='Reset to default.',Panel='calibratePanel'},
  {Command='ResetBlueSaturation',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/CameraRawSettingMapping/BlueSaturationCalibration=Blue Saturation Calibration')),Group=calibration,Explanation='Reset to default.',Panel='calibratePanel'},
  --
  ...
  {Command='MaskNewSubject',Type='button',Translation=LOC('$$$/AgDevelop/Localized/MaskGroup/NewMask=New ^1',LOC'$$$/AgDevelop/Localized/MaskGroup/SelectSubject=subject'),Group=mask,Explanation=''},
  {Command='MaskNewSky',Type='button',Translation=LOC('$$$/AgDevelop/Localized/MaskGroup/NewMask=New ^1',LOC'$$$/AgDevelop/Localized/MaskGroup/SelectSky=sky'),Group=mask,Explanation=''},
  {Command='MaskNewBack',Type='button',Translation=LOC('$$$/AgDevelop/Localized/MaskGroup/NewMask=New ^1',LOC'$$$/AgDevelop/Localized/MaskGroup/SelectBackground=background'),Group=mask,Explanation=''},
  {Command='MaskNewObj',Type='button',Translation=LOC('$$$/AgDevelop/Localized/MaskGroup/NewMask=New ^1',LOC'$$$/AgDevelop/Localized/MaskGroup/SelectObject=object'),Group=mask,Explanation=''},
  ...
  {Command='MaskNewPeople',Type='button',Translation=LOC('$$$/AgDevelop/Localized/MaskGroup/NewMask=New ^1',LOC'$$$/AgDevelop/Localized/MaskGroup/SelectPerson=persons'),Group=mask,Explanation=''},
  {Command='MaskNewLand',Type='button',Translation=LOC('$$$/AgDevelop/Localized/MaskGroup/NewMask=New ^1',LOC'$$$/AgDevelop/Localized/MaskGroup/SelectLandscape=Landscape'),Group=mask,Explanation=''},

  {Command='MaskAddSubject',Type='button',Translation=LOC('$$$/AgDevelop/Localized/Masking/AddToMask=Add ^1 to the mask',LOC'$$$/AgDevelop/Localized/MaskGroup/SelectSubject=subject'),Group=mask,Explanation=''},
  {Command='MaskAddSky',Type='button',Translation=LOC('$$$/AgDevelop/Localized/Masking/AddToMask=Add ^1 to the mask',LOC'$$$/AgDevelop/Localized/MaskGroup/SelectSky=sky'),Group=mask,Explanation=''},
  {Command='MaskAddBack',Type='button',Translation=LOC('$$$/AgDevelop/Localized/Masking/AddToMask=Add ^1',LOC'$$$/AgDevelop/Localized/MaskGroup/SelectBackground=background'),Group=mask,Explanation=''},
  {Command='MaskAddObj',Type='button',Translation=LOC('$$$/AgDevelop/Localized/Masking/AddToMask=Add ^1',LOC'$$$/AgDevelop/Localized/MaskGroup/SelectObject=object'),Group=mask,Explanation=''},
  ...
  {Command='MaskAddPeople',Type='button',Translation=LOC('$$$/AgDevelop/Localized/Masking/AddToMask=Add ^1',LOC'$$$/AgDevelop/Localized/MaskGroup/SelectPerson=persons'),Group=mask,Explanation=''},
  {Command='MaskAddLand',Type='button',Translation=LOC('$$$/AgDevelop/Localized/Masking/AddToMask=Add ^1',LOC'$$$/AgDevelop/Localized/MaskGroup/SelectLandscape=Landscape'),Group=mask,Explanation=''},

  {Command='MaskSubSubject',Type='button',Translation=LOC('$$$/AgDevelop/Localized/MaskGroup/NewComponent/Subtract=Subtract from mask...')..' '..LOC('$$$/AgDevelop/Localized/MaskGroup/SelectSubject=subject'),Group=mask,Explanation=''},
  {Command='MaskSubSky',Type='button',Translation=LOC('$$$/AgDevelop/Localized/MaskGroup/NewComponent/Subtract=Subtract from mask...')..' '..LOC('$$$/AgDevelop/Localized/MaskGroup/SelectSky=sky'),Group=mask,Explanation=''},
  {Command='MaskSubBack',Type='button',Translation=LOC('$$$/AgDevelop/Localized/MaskGroup/NewComponent/Subtract=Subtract from mask...')..' '..LOC('$$$/AgDevelop/Localized/MaskGroup/SelectBackground=background'),Group=mask,Explanation=''},
  {Command='MaskSubObj',Type='button',Translation=LOC('$$$/AgDevelop/Localized/MaskGroup/NewComponent/Subtract=Subtract from mask...')..' '..LOC('$$$/AgDevelop/Localized/MaskGroup/SelectObject=object'),Group=mask,Explanation=''},
  ...
  {Command='MaskSubPeople',Type='button',Translation=LOC('$$$/AgDevelop/Localized/MaskGroup/NewComponent/Subtract=Subtract from mask...')..' '..LOC('$$$/AgDevelop/Localized/MaskGroup/SelectPerson=persons'),Group=mask,Explanation=''},
  {Command='MaskIntSubject',Type='button',Translation=LOC('$$$/AgDevelop/Localized/MaskGroup/NewComponent/Intersect=Intersect with mask...')..' '..LOC('$$$/AgDevelop/Localized/MaskGroup/SelectSubject=subject'),Group=mask,Explanation=''},
  {Command='MaskIntSky',Type='button',Translation=LOC('$$$/AgDevelop/Localized/MaskGroup/NewComponent/Intersect=Intersect with mask...')..' '..LOC('$$$/AgDevelop/Localized/MaskGroup/SelectSky=sky'),Group=mask,Explanation=''},
  ...
  {Command='MaskIntBack',Type='button',Translation=LOC('$$$/AgDevelop/Localized/MaskGroup/NewComponent/Intersect=Intersect with mask...')..' '..LOC('$$$/AgDevelop/Localized/MaskGroup/SelectBackground=background'),Group=mask,Explanation=''},
  {Command='MaskIntObj',Type='button',Translation=LOC('$$$/AgDevelop/Localized/MaskGroup/NewComponent/Intersect=Intersect with mask...')..' '..LOC('$$$/AgDevelop/Localized/MaskGroup/SelectObject=object'),Group=mask,Explanation=''},
  {Command='MaskIntPeople',Type='button',Translation=LOC('$$$/AgDevelop/Localized/MaskGroup/NewComponent/Intersect=Intersect with mask...')..' '..LOC('$$$/AgDevelop/Localized/MaskGroup/SelectPerson=persons'),Group=mask,Explanation=''},
  {Command='MaskIntLand',Type='button',Translation=LOC('$$$/AgDevelop/Localized/MaskGroup/NewComponent/Intersect=Intersect with mask...')..' '..LOC('$$$/AgDevelop/Localized/MaskGroup/SelectLandscape=Landscape'),Group=mask,Explanation=''},
  ...
  {Command='local_Whites',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Whites=Whites')..' (PV 3+)',PV3=locadj..' '..LOC('$$$/AgDevelop/Localized/Whites=Whites'),Group=localizedAdjustments,Explanation='Adjust Whites for the currently active tool: Brush, Radial Filter, or Graduated Filter.',AltParameter='Direct'},
  {Command='local_Blacks',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Blacks=Blacks')..' (PV 3+)',PV3=locadj..' '..LOC('$$$/AgDevelop/Localized/Blacks=Blacks'),Group=localizedAdjustments,Explanation='Adjust Blacks for the currently active tool: Brush, Radial Filter, or Graduated Filter.',AltParameter='Direct'},
  ...
  {Command='local_Grain',Type='parameter',Translation=locadj..' '..LOC('$$$/AgDevelop/Localized/Grain/Label=Grain')..' (PV 6+)',PV6=locadj..' '..LOC('$$$/AgDevelop/Localized/Grain/Label=Grain'),Group=localizedAdjustments,Explanation='Adjust Grain for the currently active tool: Brush, Radial Filter, or Graduated Filter.',AltParameter='Direct'},
  ...
  {Command='Resetlocal_Highlights',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Highlights=Highlights')..' (PV 3+)'),PV3=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Highlights=Highlights')),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Shadows',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Shadows=Shadows')..' (PV 3+)'),PV3=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Shadows=Shadows')),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Whites',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Whites=Whites')..' (PV 3+)'),PV3=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Whites=Whites')),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Blacks',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Blacks=Blacks')..' (PV 3+)'),PV3=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Blacks=Blacks')),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Temperature',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Temperature=Temp.')..' (PV 3+)'),PV3=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Temperature=Temp.')),Group=localadjresets,Explanation='Reset to default.'},
  ...
  {Command='Resetlocal_Dehaze',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Dehaze=Dehaze')..' (PV 3+)'),PV3=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Dehaze=Dehaze')),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Grain',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Grain/Label=Grain')..' (PV 6+)'),PV6=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Grain/Label=Grain')),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_Sharpness',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Sharpness=Sharpness')..' ('..P2and3plus..')'),PV2=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/Sharpness=Sharpness')),Group=localadjresets,Explanation='Reset to default.'},
  {Command='Resetlocal_LuminanceNoise',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/LuminanceNoiseReduction=Luminance Noise Reduction')..' (PV 3+)'),PV3=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',locadj..' '..LOC('$$$/AgDevelop/Localized/LuminanceNoiseReduction=Luminence Noise Reduction')),Group=localadjresets,Explanation='Reset to default.'},
  ...
  {Command='ResetstraightenAngle',Type='button',Translation=LOC('$$$/AgDevelop/Localized/ResetTitle=Reset ^1',LOC('$$$/AgCameraRawNamedSettings/SaveNamedDialog/StraightenAngle=Straighten Angle')),Group=crop,Explanation='Reset crop angle.'},
...
for _,v in ipairs(DataBase) do
  ...
  if v.Panel then
    ...
    if v.SubPanel then
      CmdSubPanel[v.Command] = v.SubPanel
    end
  end
